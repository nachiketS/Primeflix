...
<?php
	...
	$uname=$_SESSION['unam'];
	$result=$conn->query("SELECT * FROM titles join titless on titles.id = titless.id join posters on titles.id = posters.id join mylist on titles.id=mylist.id WHERE mylist.uname='$uname' ");
?>
<div class=row>
