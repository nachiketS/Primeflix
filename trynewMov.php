...
<?php
	...
	if($_SERVER['REQUEST_METHOD']=="POST"){
		...
		if($flag==10){
			$conn->query("CALL addactor('$actor1','$actor2','$actor3')");
...
<input type="text" name="poster" placeholder="Poster link"><br><?php echo $posterErr; ?>
<input type="text" name="bg" placeholder="Background Link"><br><?php echo $bgErr; ?>
<input type="text" name="trailer" placeholder="trailer link"><br><?php echo $trailerErr; ?>
...
<input type="text" name="movie" placeholder="movie link"><br>
