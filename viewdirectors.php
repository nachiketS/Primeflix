...
<?php 
	...
	while($row=$result->fetch_assoc()){
		echo "<tr><td>".$row['directorName']."</td><td><a href = \"editdirector.php?id=$row[did]\">edit</a></td><td><a href = \"deletedirector.php?id=$row[did]\">delete</a></td></tr>";
	}
	echo "</table>";
?>
...
<input type = "text" placeholder="new director" name="newdirector">
